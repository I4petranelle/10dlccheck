...
let STORE = {
  ...
  patterns: {
    ...
    url: "(https?://\\S+)",
    other_lenders_regex:
      "\\b(headway|mulligan|credibly|on\\s?deck|libertas|alliance funding group|cfg|peac solutions|kcg|byzfunder|good funding|channel partners|elevate|expansion|forward financing|fox|fundation|pearl|kapitus|rapid)\\b",
    risky_terms_regex:
